...
export class AuthHTTPService {
  ...
  updatePhone(model: UpdatePhoneModel): Observable<any> {
    return this.http.post<any>(`${API_AUTH_URL}/UpdatePhone`, model);
  }
  ...
  resetPassword(email: string) :Observable<any>{
    return this.http.post<any>(`${API_AUTH_URL}/ResetPassword`,{ email: email })
  }
}
