  ...
  data: {
    ...
    PAYMENT_METHODS: {
      FORM: {
        ...
        UPDATE_PAYMENT_METHOD: 'تحديث وسيلة الدفع : {{name}}',
      },
      INPUT: {
        BANK_NAME: 'اسم البنك',
        ACCOUNT_OWNER: 'اسم صاحب الحساب البنكي',
        ACCOUNT_NUMBER: 'رقم الحساب',
        CURRENCY: 'العملة',
        IBAN: 'الأيبان (الرقم الدولي للحساب البنكي) (IBAN)',
        SWIFT_CODE: 'رمز السويفت/الرمز المعرف للبنك (Swift Code)',
        DEFAULT_METHOD: 'وسيلة دفع أساسية',
        COUNTRY:'الدولة',
        CITY:'المدينة',
        STREET:'اسم الشارع',
        POSTAL_CODE:'رقم البريد / رمز البريد'
      },
      VALIDATION: {
        REQUIRED: '{{name}} مطلوب',
      },
    ...
    CAMPAIGN: {
      ...
      VALIDATION: {
        REQUIRED: '{{name}} مطلوب',
        INVALID_PRICE: 'المبلغ غير كافي',
        INVALID_PERCENTAGE: 'النسبة المئوية غير كافية',
      },
      TABLE:{
        WORKSPACE_CAMPAIGNS:{
          TITLE:'قائمة الحملات',
